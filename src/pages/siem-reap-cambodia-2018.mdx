...
<PostImage justifyContent="center">
  <ImagePro
    name="angkor-closeup-from-stairs.jpg"
    widths={[470, 700, 1100]}
...
<PostImage height="365px">
  <ImagePro
    name="rakshah-bridge.jpg"
    widths={[550, 600, 1100]}
    sizes="(max-width: 1100px) 100vw, 550px"
  />
  <ImagePro
    name="angkor-thom.jpg"
    widths={[233, 600, 1100]}
    sizes="(max-width: 1100px) 100vw, 233px"
  />
</PostImage>
...
<PostImage height="750px" justifyContent="center">
  <ImagePro
    name="gate-of-the-dead-bargain.jpg"
    widths={[538, 800, 1100]}
...
<PostImage justifyContent="center">
  <ImagePro
    name="sumit-mangela-B042IxVei-4-unsplash.jpg"
    widths={[538, 800, 1100]}
...
<PostImage justifyContent="center">
  <ImagePro
    name="siddhesh-mangela-0bx_FfcNYoc-unsplash.jpg"
    widths={[538, 800, 1100]}
    sizes="(max-width: 1100px) 100vw, 792px"
  />
