...
description: 'It was already night when we reached Siem Reap Airport. Packed on airline food, all I wanted was to hit the hay.
...
<PostStamp pubDate={frontmatter.pubDate} />
...
<PostImage justifyContent="center">
  <ImagePro
    ...
    sizes="(max-width: 1100px) 100vw, 792px"
  />
  <span slot="caption">_Preah prom rath Pagoda_</span>
</PostImage>
...
<PostImage justifyContent="center">
  <ImagePro
    ...
    sizes="(max-width: 1100px) 100vw, 792px"
  />
  <span slot="caption">_A Buddhist monk we met_</span>
</PostImage>
...
<PostImage justifyContent="center">
  <ImagePro
    name="kbal-spean-vishnu"
    widths={[538, 800, 1100]}
    sizes="(max-width: 1100px) 100vw, 792px"
  />
  <span slot="caption">_Vishnu resting, River of 1000 Lingas_</span>
</PostImage>
